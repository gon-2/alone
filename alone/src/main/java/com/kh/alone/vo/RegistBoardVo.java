...
public class RegistBoardVo {
	...
	public RegistBoardVo(int class_board_number, String class_board_enroll, String class_board_title,
			String class_board_content, String class_board_userid, Timestamp class_board_postdate,
			int class_board_viewcnt, String class_board_comment) {
		super();
